    ...
    protected abstract class AbstractUnsafe implements Unsafe {
        ...
        private void register0(ChannelPromise promise) {
            try {
                ...
                // 确保我们在实际通知 Promise 之前调用 handlerAdded(...)。这是必需的，
                // 因为用户可能已经通过 ChannelFutureListener 中的管道触发事件。
                ...
                // 仅当通道从未注册过时才触发通道活动。这可以防止射击
                // 如果通道被取消注册并重新注册，则多个通道处于活动状态。
                if (isActive()) {
